    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 2:
                ...
                user = users[0];
                if (!user)
                    return [2 /*return*/, res.status(404).json({ error: 'No such user exist.' })];
                return [4 /*yield*/, payload.find({
                        collection: 'orders',
                        depth: 2,
                        where: {
            ...
            case 3:
                ...
                order = orders[0];
                if (!order)
                    return [2 /*return*/, res.status(404).json({ error: 'No such order exist.' })];
            ...
            case 6: return [4 /*yield*/, _b.apply(_a, [(_c.html = _e.sent(),
                        _c)])];
            case 7:
                data = _e.sent();
