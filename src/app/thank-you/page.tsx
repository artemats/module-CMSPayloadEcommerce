...
const ThankYouPage = async ({ searchParams }: IThankYouPage) => {
  ...
  return (
    <div className="relative lg:h-[calc(100vh-64px)]">
      <div className="hidden lg:block lg:absolute lg:h-full lg:w-1/2 lg:pr-4 xl:pr-12">
        <Image
          fill
          src="/thank-you.jpg"
                      ...
                      <div className="relative h-24 w-24">
                        {typeof image !== 'string' && image.url ? (
                          <Image
                            ...
                            className="flex-none rounded-md bg-gray-100 object-contain object-center"
                          />
                        ) : null}
                      </div>
